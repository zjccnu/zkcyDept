		                       ...
		                       this.$http.jsonp(getMessageSta
		                               ...
		                               deleteMessage:function(index){
		                              	//获取当前删除的Id
		                                   var msg = "您真的确定要删除吗？\n\n请确认！";
											if (confirm(msg)==true){
										    this.seriNum=this.messageInfo[index].messageId
											this.doDelete(index); 
											return true;
											}else{
											return false;
		                              ...
		                              doDelete:function(index){
		                              	 this.$http.jsonp(
		                               	 	  ...
		                               	 	  //   emulateJSON: true,
		                                             ...
		                                             // alert("波哥提示您,删除成功");
		                                              //删除成功后
							                         this.messageInfo.splice(index,1);
		                              			 }, function(res){	 
		                                             alert("波哥提示您,删除失败");
		                                             $("#box").text(res.data);
		                             			 })
		                              ...
		                              alter:function(index){
		                              	alterMessage(this.messageInfo[index]);
		                              }
		                          }
    			})
